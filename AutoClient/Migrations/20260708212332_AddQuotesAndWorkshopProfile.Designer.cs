...
namespace AutoClient.Migrations
{
    ...
    [Migration("20260708212332_AddQuotesAndWorkshopProfile")]
    partial class AddQuotesAndWorkshopProfile
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AutoClient.Models.Quote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("WorkshopId", "QuoteNumber")
                        .IsUnique();

                    b.ToTable("Quotes");
                });

            modelBuilder.Entity("AutoClient.Models.QuoteItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AutoClient.Models.QuoteItem", b =>
                {
                    b.HasOne("AutoClient.Models.Quote", "Quote")
                        .WithMany("Items")
